...
function _default(_ref) {
  ...
  function importMethod(useES, methodName, file) {
    if (!selectedMethods[methodName]) {
      var path = (0, _modules.default)(useES, methodName); // 因rambdax src中使用的export const/function而非 export default故需将addNamed方法替换为addNamespace

      selectedMethods[methodName] = (0, _helperModuleImports.addNamespace)(file.path, path, {
        nameHint: methodName
      });
    }
